...
I implement multiprocess to handle four population to add variety of GA. The following is the Optimized topology by island model GA and figure for average fitness of 4 islands to generation.
